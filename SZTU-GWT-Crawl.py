...
if __name__ == '__main__':
    ...
    while True:
        ...
        emailContent = create_email_content_from_new_announcement(AnnouncementInfo,start_time)
        print(str(len(AnnouncementInfo.academy_list))+' new announcement(s)')
        download_web_file(AnnouncementInfo,Headers.headers)
        send_GWT_message(emailContent,AnnouncementInfo) # ,AnnouncementInfo.HTML_file_list,AnnouncementInfo.attachment_file_list
